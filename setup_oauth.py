...
def load_config() -> Dict:
    ...
    try:
        ...
        print("Error: token-config.json not found. Please create it from the template first.")
        exit(1)
...
def setup_oauth_flow():
    ...
    client_secret = input("Enter your Token Manager Integration Client Secret: ").strip()
